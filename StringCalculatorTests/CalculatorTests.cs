...
namespace StringCalculatorTests
{
    public class CalculatorTests
    {
        ...
        public void Add_ShouldBeZero(TestData testData)
        {
            ...
            //Act
            actual = String_Calculator.Add(testData.Numbers);
        ...
        public void Add_ExceptionTests(TestData testData)
        {
            ...
            //Assert
            Assert.Throws<ApplicationException>(() =>String_Calculator.Add(testData.Numbers));
        }
    }


    //TODO: Create factory for test data generation
